...
class DomaineController extends Controller
{
    ...
    {
        $domaine = new Domaine();
        $form = $this->createForm('DatabaseBundle\Form\DomaineType', $domaine);
    ...
    {
        $deleteForm = $this->createDeleteForm($domaine);
        $editForm = $this->createForm('DatabaseBundle\Form\DomaineType', $domaine);
